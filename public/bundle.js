...
var _Main_button = __webpack_require__(68);
...
var MainButton = function MainButton(props) {
  return _react2.default.createElement(
    "div",
    { className: "main-buttons", onClick: function onClick() {
        return props.onButtonClick();
      } },
    _react2.default.createElement("img", { className: "iconImg", src: props.img, alt: props.title + "icons" }),
    _react2.default.createElement(
      "span",
      null,
      props.title
