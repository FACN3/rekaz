const languages = {
  en: {
    ...
    "chart2": "This Chart shows how the percentage of smokers is changed with time",
  ...
  ar: {
    ...
    "smokingDiscription": "ظاهرة التدخين قي الوسط العربي تتفاقم بشكل اذ ترتفع نسبة المدخنين من الاناث والرجال بشكل عام, في حين تنخفض نسبة المدخنين من حملة اللقب الأول مثلاً, من خلال تصفحك الرسوم البيانية ادناه ستتمكن من اخذ الصورة عن ظاهرة التدخين في الوسط العربي",
    "chart1":"يوضح الرسم البياني ادناه نسبة المدخنين في الوسط العربي من رجال, اناث وكلا جنسين, يمكن ايضاً تحديد فئة معينة مثلاً حسب جيل أو دخل أسرة معين ",
    "chart2":"يوضح الرسم البياني تالي كيف تتغير نسبة المدخنين عبر الزمن يمكن ايضاً تحديد فئة معينة ",
    "chart3":"يوضح الرسم البياني التالي عدد السجائر التي يسىتهلكها المدخنون حيث تم تقسيم المدخنين الى ثلاث شرائح هم : عشرة سجائر فما دون, بين عشرة وعشرون سيجارة وعشرون سيجارة او اكثر.",
    "chart4":"التدخين هي من اكثر العادات السيئة التي تؤدي إلى الادمان,  يوضح رسم البياني التالي الاسباب التي لم تمكن المدخنين الذين لديهم نية عن اقلاغ عن التدخين",
