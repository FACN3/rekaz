  ...
  return (
    <div>
      ...
      <div className="charts">
        ...
        <FourthChartCon languages={props.languages} name="fourth" data={{values:chart04Data.values,colors:chart04Data.colors,labels:props.languages.labels4}} />
        <h2>{props.languages.chartDefault}</h2>
        <FourthChartCon languages={props.languages} name="fith" data={{values:chart05Data.values,colors:chart05Data.colors,labels:props.languages.labels5}} />
      </div>
    </div>
  );
};
